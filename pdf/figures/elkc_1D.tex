...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(2611,484){\makebox(0,0){\strut{}-2}}%
      \put(3809,484){\makebox(0,0){\strut{} 0}}%
      \put(5006,484){\makebox(0,0){\strut{} 2}}%
      \put(6204,484){\makebox(0,0){\strut{} 4}}%
      \csname LTb\endcsname%
      \put(176,2739){\rotatebox{90}{\makebox(0,0){\strut{}$\LKC_j$}}}%
      \put(3808,154){\makebox(0,0){\strut{}$\lset$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(5816,4602){\makebox(0,0)[r]{\strut{}$j=0$}}%
      \csname LTb\endcsname%
      \put(5816,4382){\makebox(0,0)[r]{\strut{}$j=1$ ($\bullet/\Msize$)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{./figures/elkc_1D}}%
    \gplfronttext
  \end{picture}%
\endgroup
