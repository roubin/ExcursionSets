...
%% Plot
p.hitting_set.thresholds=f_set_thresholds(-10,10,0.01);
%figure(1); plot(p.hitting_set.thresholds,th_elkc(3,p.hitting_set));
%figure(2); plot(p.hitting_set.thresholds,th_elkc(2,p.hitting_set));
%figure(3); plot(p.hitting_set.thresholds,th_elkc(1,p.hitting_set));
figure(4); plot(p.hitting_set.thresholds,th_elkc(0,p.hitting_set));
