...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(176,2739){\rotatebox{-270}{\makebox(0,0){\strut{}Normalized failure stress $\sfail$}}}%
      \put(3940,154){\makebox(0,0){\strut{}Scale ratio $\rlinv = \Msize/\Lc$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(1210,888){\makebox(0,0)[l]{\strut{}couco}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{./figures/percolation_3D}}%
    \gplfronttext
  \end{picture}%
\endgroup
